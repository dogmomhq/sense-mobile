...
function Icon({ tab, color, size }) {
  const sw = 2;
  if (tab === 'home') return (   // house (B53: HOME + HISTORY shared the paw — CJ wants distinct icons)
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M3 11.2 L12 3.4 L21 11.2" stroke={color} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M5.6 9.8 V20.2 H18.4 V9.8" stroke={color} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M9.7 20.2 V14.4 H14.3 V20.2" stroke={color} strokeWidth={sw} strokeLinejoin="round" />
    </Svg>);
  if (tab === 'history') return (   // clock (B53: distinct from HOME)
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx={12} cy={12} r={8.8} stroke={color} strokeWidth={sw} />
      <Path d="M12 6.6 V12 L15.9 14.4" stroke={color} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>);
