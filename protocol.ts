...
export interface AsyncAnswerMsg { type: 'async-answer'; matchId: string; answerIndex: number; clientTime: number; name?: string | null; token?: string | null; supabaseToken?: string | null; imgMs?: number; driftMs?: number; }
...
export const asyncAnswer = (matchId: string, answerIndex: number, clientTime: number, identity: { name?: string | null; token?: string | null; supabaseToken?: string | null } = {}, imgMs?: number | null, driftMs?: number | null): AsyncAnswerMsg =>
  ({ type: 'async-answer', matchId, answerIndex, clientTime, ...identity, ...(imgMs != null ? { imgMs } : {}), ...(driftMs != null ? { driftMs } : {}) });
