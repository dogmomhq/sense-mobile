...
import { View, Text, Image, ImageBackground, Pressable, StyleSheet, SafeAreaView, StatusBar, ScrollView, Animated, Easing, Platform, useWindowDimensions, TextInput, Share, PanResponder, Modal, ActivityIndicator } from 'react-native';
...
const st = StyleSheet.create({
  ...
  balCard:{backgroundColor:'rgba(34,197,94,0.10)',borderRadius:14,padding:16,marginBottom:14,alignItems:'center'}, balCardLabel:{color:C.text2,fontFamily:F.m,fontSize:11,letterSpacing:1,textTransform:'uppercase'}, balCardVal:{color:C.win,fontFamily:F.k,fontSize:30,marginTop:2}, pendCountdown:{fontFamily:F.m,fontSize:11,color:C.text2,marginTop:2},
